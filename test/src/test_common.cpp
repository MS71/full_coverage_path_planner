...
TEST(TestMakeTestGrid, testDimensions)
{
  ...
  ASSERT_EQ(4, (int)grid.size());
  ASSERT_EQ(3, (int)grid.at(0).size());
  ASSERT_EQ(3, (int)grid.at(1).size());
  ASSERT_EQ(3, (int)grid.at(2).size());
  ASSERT_EQ(3, (int)grid.at(3).size());
 ...
 */
  ...
  ASSERT_EQ(8, (int)map_2_goals(grid, true).size());  // There are 8 true values
  ASSERT_EQ(1, (int)map_2_goals(grid, false).size());  // There is only 1 false value
}
...
TEST(TestAStarToOpenSpace, testEmptyMap)
{
  ...
  ASSERT_EQ(2, (int)pathNodes.size());
}
...
TEST(TestAStarToOpenSpace, testSingleVisitedCellMap)
{
  ...
  ASSERT_EQ(3, (int)pathNodes.size());
}
...
TEST(TestAStarToOpenSpace, testMazeMap)
{
   ...
   */
  ASSERT_EQ(false, resign);
  ASSERT_EQ(9, (int)pathNodes.size());
}
...
TEST(TestAStarToOpenSpace, testMazeWithHoleMap)
{
   ...
   */
  ASSERT_EQ(false, resign);
  ASSERT_EQ(7, (int)pathNodes.size());
}
...
TEST(TestAStarToOpenSpace, testBlockedMap)
{
  ...
  ASSERT_EQ(1, (int)pathNodes.size());  // Only the cell we start at:
